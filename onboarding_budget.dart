              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: _budgetController.text.trim().isNotEmpty
                        ? () {
                            final text = _budgetController.text.trim();
                            final income = double.tryParse(text.replaceAll(',', '')) ?? 0.0;
                            Navigator.of(context).push(
                              PageRouteBuilder(
                                pageBuilder: (context, animation, secondaryAnimation) => OnboardingPriorities(name: widget.name, income: income),
