...
class OnboardingExpenseTracking extends StatefulWidget {
  final String name;
  final double income;
  const OnboardingExpenseTracking({super.key, required this.name, required this.income});
                    ...
                    onPressed: _selectedMethod != null
                        ? (){
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => OnboardingUpdate(name: widget.name, income: widget.income),
                              ),
                            );
                          }
                        : null,
